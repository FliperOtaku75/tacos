<?php
    ...
    if(isset($_POST['confirmar'])){
		if($_POST['password'] == $_POST['password2']){
			...
			}	else {echo '<script language="javascript">alert("La contraseña y la confirmacion no coinciden");</script>';}
    }
	...
	<main>
		...
		<form method="POST" class="formularios" id="formulario">
			...
			<div class="formulario__grupo formulario__grupo-btn-enviar">
				<input type="submit" class="formulario__btn" name="confirmar" value="Confirmar"></input>
				<br>
