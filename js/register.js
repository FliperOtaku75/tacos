...
const validarFormulario = (e) => {
	switch (e.target.name) {
		...
		break;
		case "apellidom":
			validarCampo(expresiones.apellidop, e.target, 'apellidom');
		break;
		case "password":
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.nombre && campos.apellidop && campos.apellidom && campos.password && campos.correo && campos.telefono && terminos.checked ){
		formulario.submit();
