            ...
            <ul>
                <li class="submenu">
                        ...
                        <div id="carrito">
                                ...
                                <br><br><br>
                                    <form method="POST">
                                        <input type="submit" name="vaciar_todo" value="Vaciar"  class="button u-full-width" id="vinputciar-carrito"></input> 
                                        <br><br>
                                        <input type="submit" value="Comprar" id="comprar" name="comprar" class="button u-full-width"></input>
                                    </form>
                        </div>
                </li>
            </ul>
                ...
                <div class="info-card">
                    ...
                    <p class="precio">$<?php echo $guisado ['precio_oferta']; ?> <span class="u-pull-right ">$<?php echo $guisado ['precio']; ?></span></p>
                        <form enctype="multipart/form-data" method="POST">
                            <input class="formulario__input" type="number" name="cantidad" value="cantidad"></input>
